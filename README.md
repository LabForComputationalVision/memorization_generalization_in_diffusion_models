...
- training a universal blind denoiser used in a diffusion framework: run main.py which calls the trainer.py to train a denoiser. 
- sampling algorithm to sample from the prior embedded in the denoiser: see the notebooks
